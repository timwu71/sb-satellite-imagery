...
for drop_prob in drop_probs:
	...
	#TODO: WRONG PADDING ("same" padding does not work for PyTorch versions under 1.9.0)
        model = nn.Sequential(
        nn.Conv2d(channel_0, channel_1, (3, 3), padding=(1,1)),
        nn.ReLU(),
        ...
        nn.Dropout2d(drop_prob),
        nn.Conv2d(channel_2, channel_3, (3, 3), padding=(1,1)),
        nn.ReLU(),
