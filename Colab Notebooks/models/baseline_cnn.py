...
print('loading data...')
data = np.load('/home/timwu0/231nproj/clean_data', allow_pickle=True)
train_X, train_y, val_X, val_Y, trainval_X, trainval_Y, test_X, test_Y = data['train_X'], data['train_Y'], data['val_X'], data['val_Y'], data['trainval_X'], data['trainval_X'], data['test_X'], data['test_X'], 
